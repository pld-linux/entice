...
Entice to przeglądarka obrazków używająca bibliotek Enlightenmenta.
Entice aktualnie nie pobiera żadnych opcji z linii poleceń, przyjmuje
tylko listę obrazków do wczytania jako parametry. Uruchomiona bez
parametrów próbuje wczytać wszystkie pliki z bieżącego katalogu (w tej
chwili nawet te, które nie są obrazkami). Można podać nazwę katalogu
jako pojedynczy argument - wtedy przeglądarka wczyta wszystkie obrazki
z tego katalogu.
